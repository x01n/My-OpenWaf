...
- [error_pages.go](file://internal/waf/pages/error_pages.go)
...
- [page.tsx](file://frontend/app/maintenance/page.tsx)
...
subgraph "阻断执行器"
DropExec["丢弃执行器<br/>internal/waf/drop/drop.go"]
DropStats["阻断统计<br/>DropStats"]
DropReason["阻断原因<br/>DropReason"]
end
subgraph "阻断响应渲染"
Block["阻断响应渲染<br/>internal/waf/pages/block.go"]
...
- [drop.go:19-123](file://internal/waf/drop/drop.go#L19-L123)
...
**章节来源**
- [drop.go:19-123](file://internal/waf/drop/drop.go#L19-L123)
- [drop_test.go:24-123](file://internal/waf/drop/drop_test.go#L24-L123)
...
**章节来源**
- [block.go:16-39](file://internal/waf/pages/block.go#L16-L39)
- [block.go:68-94](file://internal/waf/pages/block.go#L68-L94)
...
- [drop.go:72-83](file://internal/waf/drop/drop.go#L72-L83)
...
- 相关实现参考
  - 阻断渲染与回退逻辑：[block.go:16-39](file://internal/waf/pages/block.go#L16-L39)、[block.go:68-94](file://internal/waf/pages/block.go#L68-L94)
  ...
  - 零响应阻断执行器：[drop.go:19-123](file://internal/waf/drop/drop.go#L19-L123)
