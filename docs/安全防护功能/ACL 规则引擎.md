...
## 项目结构
规则引擎位于 internal/core/rules 目录，配合内部 pipeline、action、store 模块协同工作；前端提供可视化规则构建器，便于用户编写与验证规则 DSL。
...
- [internal/core/rules/matcher.go:1-763](file://internal/core/rules/matcher.go#L1-L763)
...
- [frontend/components/rule-builder.tsx:1-520](file://frontend/components/rule-builder.tsx#L1-L520)
...
- 将规则映射为具体匹配器实例（如 CIDR、路径前缀/正则、查询包含/正则、头部包含/正则、精确路径、方法、内容类型、User-Agent、Body、查询参数等）。
- 对正则表达式进行缓存，避免重复编译。
...
- [internal/core/rules/phases.go:64-72](file://internal/core/rules/phases.go#L64-L72)
- [internal/core/rules/phases.go:85-93](file://internal/core/rules/phases.go#L85-L93)
...
- [internal/core/rules/matcher.go:18-44](file://internal/core/rules/matcher.go#L18-L44)
- [internal/core/rules/matcher.go:48-132](file://internal/core/rules/matcher.go#L48-L132)
- [internal/core/rules/matcher.go:167-261](file://internal/core/rules/matcher.go#L167-L261)
- [internal/core/rules/matcher.go:278-296](file://internal/core/rules/matcher.go#L278-L296)
...
**章节来源**
- [internal/core/rules/compiler.go:48-53](file://internal/core/rules/compiler.go#L48-L53)
- [internal/core/rules/phases.go:40-52](file://internal/core/rules/phases.go#L40-L52)
- [internal/core/action/action.go:39-49](file://internal/core/action/action.go#L39-L49)
...
- [internal/core/rules/compiler_test.go:11-87](file://internal/core/rules/compiler_test.go#L11-L87)
- [internal/core/rules/matcher_test.go:30-110](file://internal/core/rules/matcher_test.go#L30-L110)
- [internal/core/rules/matcher_test.go:188-220](file://internal/core/rules/matcher_test.go#L188-L220)
...
**图表来源**
- [internal/core/rules/compiler.go:1-20](file://internal/core/rules/compiler.go#L1-L20)
- [internal/core/rules/matcher.go:1-14](file://internal/core/rules/matcher.go#L1-L14)
- [internal/core/rules/phases.go:1-17](file://internal/core/rules/phases.go#L1-L17)
...
**章节来源**
- [internal/core/rules/matcher.go:278-296](file://internal/core/rules/matcher.go#L278-L296)
- [internal/core/rules/phases.go:142-170](file://internal/core/rules/phases.go#L142-L170)
- [internal/core/rules/phases.go:109-128](file://internal/core/rules/phases.go#L109-L128)
...
- [internal/core/rules/compiler_test.go:11-87](file://internal/core/rules/compiler_test.go#L11-L87)
- [internal/core/rules/matcher_test.go:30-110](file://internal/core/rules/matcher_test.go#L30-L110)
- [internal/core/rules/matcher.go:169-185](file://internal/core/rules/matcher.go#L169-L185)
- [internal/core/rules/matcher.go:191-204](file://internal/core/rules/matcher.go#L191-L204)
- [internal/core/rules/matcher.go:309-342](file://internal/core/rules/matcher.go#L309-L342)
...
**章节来源**
- [internal/core/action/action.go:40-57](file://internal/core/action/action.go#L40-L57)
