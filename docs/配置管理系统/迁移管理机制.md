...
- 存储层与模型：internal/store
  ...
  - 数据模型定义：internal/store/models.go
  - 仓库聚合器：internal/store/repository/repository.go
  - 管理员账户仓库：internal/store/repository/admin_account.go
...
REPOS["仓库聚合器<br/>internal/store/repository/repository.go"]
ACC_REPO["管理员账户仓库<br/>internal/store/repository/admin_account.go"]
end
subgraph "数据库层"
...
图表来源
- [server.go:35-70](file://internal/app/server.go#L35-L70)
- [migrate.go:9-37](file://internal/store/migrate.go#L9-L37)
- [seed.go:13-61](file://internal/store/seed.go#L13-L61)
- [models.go:239-243](file://internal/store/models.go#L239-L243)
...
图表来源
- [server.go:45-70](file://internal/app/server.go#L45-L70)
- [migrate.go:9-37](file://internal/store/migrate.go#L9-L37)
- [seed.go:13-61](file://internal/store/seed.go#L13-L61)
...
- 执行顺序
  ...
  - 结构迁移覆盖证书、策略、规则、站点、系统设置、管理员 API Key、配置修订、管理员账户、刷新令牌、安全事件、IP 黑白名单、令牌黑名单、登录尝试、活动会话、丢弃事件、机器人评分日志、指纹记录、CVE 同步日志等。
- 版本管理
...
Hist --> Schema["执行 GORM 结构迁移<br/>models.go"]
Schema --> Done(["完成"])
```
...
章节来源
- [models.go:67-77](file://internal/store/models.go#L67-L77)
- [cve_feed.go:77-90](file://internal/waf/cve_feed.go#L77-L90)
