...
subgraph "规则编译与匹配"
C["规则编译器<br/>internal/core/rules/compiler.go"]
P["规则匹配器<br/>internal/core/rules/matcher.go"]
PH["阶段实现<br/>internal/core/rules/phases.go"]
end
subgraph "引擎与流水线"
...
subgraph "管理接口"
HR["规则处理器<br/>internal/admin/rule/rule.go"]
...
- [phases.go:77-94](file://internal/core/rules/phases.go#L77-L94)
...
- [rule.go:46-102](file://internal/admin/rule/rule.go#L46-102)
...
- [compiler.go:28-55](file://internal/core/rules/compiler.go#L28-L55)
- [compiler.go:58-82](file://internal/core/rules/compiler.go#L58-L82)
- [matcher.go:317-342](file://internal/core/rules/matcher.go#L317-L342)
- [matcher.go:167-261](file://internal/core/rules/matcher.go#L167-L261)
...
**章节来源**
- [rule.go:16-102](file://internal/admin/rule/rule.go#L16-L102)
...
**章节来源**
- [rule.go:115-156](file://internal/admin/rule/rule.go#L115-L156)
- [matcher.go:189-195](file://internal/core/rules/matcher.go#L189-L195)
- [matcher.go:213-195](file://internal/core/rules/matcher.go#L213-L216)
...
- [matcher_test.go:30-221](file://internal/core/rules/matcher_test.go#L30-L221)