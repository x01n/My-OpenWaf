...
**图表来源**
- [engine.go:85-120](file://internal/core/engine/engine.go#L85-L120)
- [phases.go:32-94](file://internal/core/rules/phases.go#L32-L94)
...
**图表来源**
- [phases.go:64-73](file://internal/core/rules/phases.go#L64-L73)
...
- [matcher.go:271-296](file://internal/core/rules/matcher.go#L271-L296)
- [owasp.go:38-46](file://internal/waf/owasp.go#L38-L46)
...
## 附录
- 关键数据结构与流程参考路径
  - 规则模型与阶段：[models.go:44-92](file://internal/store/models.go#L44-L92)
  - 规则编译与排序：[compiler.go:27-55](file://internal/core/rules/compiler.go#L27-L55)
  - 匹配器构建与缓存：[matcher.go:167-261](file://internal/core/rules/matcher.go#L167-L261), [matcher.go:271-296](file://internal/core/rules/matcher.go#L271-L296)
  - 签名阶段执行：[phases.go:54-73](file://internal/core/rules/phases.go#L54-L73)
  - 引擎流水线组装：[engine.go:85-120](file://internal/core/engine/engine.go#L85-L120)
  - 管理端规则操作：[handler_rule.go:16-102](file://internal/admin/handler_rule.go#L16-L102), [handler_rule.go:113-156](file://internal/admin/handler_rule.go#L113-L156), [handler_rule.go:158-196](file://internal/admin/handler_rule.go#L158-L196)
  - 规则仓库接口：[rule.go:13-40](file://internal/store/repository/rule.go#L13-L40)
  - OWASP默认规则与扩展：[owasp.go:48-234](file://internal/waf/owasp.go#L48-L234), [owasp_extended.go:58-76](file://internal/waf/owasp_extended.go#L58-L76)
  - 语义视图（延迟解析）：[semantic.go:11-55](file://internal/waf/semantic.go#L11-L55)