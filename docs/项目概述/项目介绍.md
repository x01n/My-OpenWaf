...
- [internal/waf/ratelimit/ratelimit.go:9-126](file://internal/waf/ratelimit/ratelimit.go#L9-L126)
...
- 数据面（Data Plane）
  ...
  - WAF 引擎：解析站点、执行维护检查，并按 IPReputation、AntiReplay、ACL、OWASP、CVE、BotDetection、RequestRateLimit、Signature、Custom 组装阶段链
...
章节来源
- [internal/admin/router.go:29-137](file://internal/admin/router.go#L29-L137)
- [internal/store/site.go:19-84](file://internal/store/site.go#L19-L84)
- [internal/store/system.go:3-23](file://internal/store/system.go#L3-L23)
- [internal/store/protection.go:8-85](file://internal/store/protection.go#L8-L85)
- [internal/core/engine/engine.go:15-106](file://internal/core/engine/engine.go#L15-L106)
- [internal/waf/ratelimit/ratelimit.go:9-126](file://internal/waf/ratelimit/ratelimit.go#L9-L126)
- [internal/waf/iprep/iprep.go:19-207](file://internal/waf/iprep/iprep.go#L19-L207)
...
- 站点解析与维护检查
  ...
  - 全局或站点级维护模式优先拦截
- 规则阶段顺序
  - IPReputation（白名单短路、黑名单直接拦截）
  - AntiReplay
  - ACL
  - OWASP 默认规则
  - CVE 检测
  - BotDetection（机器人评分与高风险流量处理）
  - RequestRateLimit
  - Signature
  - Custom
- 动作与观测
  - ACL allow 命中会短路后续阶段；Drop、Intercept、RateLimit、Redirect 等非 Challenge 终端动作立即返回；Challenge 类动作会暂存并允许后续更高优先级终端动作覆盖；Observe 命中用于审计日志
...
OWASP --> |否| CVE
OWASPPhase --> CVE{"启用 CVE?"}
CVE --> |是| CVEPhase["CVE 检测"]
CVE --> |否| Bot
CVEPhase --> Bot{"启用机器人检测?"}
