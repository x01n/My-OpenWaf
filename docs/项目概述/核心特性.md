...
- [internal/store/protection.go](file://internal/store/protection.go)
- [internal/store/ip_list.go](file://internal/store/ip_list.go)
- [internal/store/events.go](file://internal/store/events.go)
- [docs/项目概述/核心特性.md](file://docs/项目概述/核心特性.md)
- [docs/WAF 引擎系统/WAF 引擎系统.md](file://docs/WAF 引擎系统/WAF 引擎系统.md)
- [docs/安全防护功能/机器人检测.md](file://docs/安全防护功能/机器人检测.md)
...
- [docs/管理 API 系统/管理 API 系统.md](file://docs/管理 API 系统/管理 API 系统.md)
- [docs/前端管理界面/前端管理界面.md](file://docs/前端管理界面/前端管理界面.md)
</cite>
...
- WAF 引擎：按阶段组织规则链（IP 信誉、AntiReplay、ACL、OWASP、CVE、机器人、请求速率限制、签名、自定义）。
...
- 实现原理
  - 引擎按阶段组织规则链：IP 信誉（白名单短路、黑名单直接拦截）、AntiReplay、ACL、OWASP 内置规则、CVE 专项检测、机器人检测、请求速率限制、签名与自定义规则。
...
- 配置要点与使用路径
  ...
  - 参考路径：[internal/core/engine/engine.go](file://internal/core/engine/engine.go)、[internal/waf/owasp/owasp.go](file://internal/waf/owasp/owasp.go)、[internal/waf/bot/bot.go](file://internal/waf/bot/bot.go)、[internal/store/protection.go](file://internal/store/protection.go)
...
- 配置要点与使用路径
  ...
  - 参考路径：[internal/waf/iprep/iprep.go](file://internal/waf/iprep/iprep.go)、[internal/waf/bot/bot.go](file://internal/waf/bot/bot.go)、[internal/waf/owasp/owasp.go](file://internal/waf/owasp/owasp.go)、[internal/store/protection.go](file://internal/store/protection.go)
...
## 结论
My-OpenWaf 以“控制平面 + 数据平面”的清晰分层，结合 Go 高性能引擎与 Next.js 现代化前端，提供了多站点隔离、可视化管理、热重载与分布式同步的完整能力矩阵。其全面的安全防护体系覆盖 IP 信誉、ACL、OWASP、CVE、机器人检测与请求速率限制，并通过可配置的保护策略满足不同场景需求。建议在生产环境中启用 Redis 分布式同步与完善的日志监控，以获得更稳健的运维体验。
