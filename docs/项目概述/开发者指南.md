...
- [wasm-pow-solver/src/lib.rs](file://wasm-pow-solver/src/lib.rs)
...
- WASM 挑战
  - Rust crate wasm-pow-solver/ 经 wasm-bindgen 编译出 pow.wasm 与 pow_glue.js，实现 PoW 解题、环境指纹采集与加密，用于 5s 盾等挑战场景。
...
章节来源
- [internal/waf/challenge/pow.go](file://internal/waf/challenge/pow.go)
...
- WASM 挑战无法初始化
  - 确认浏览器支持 WebAssembly，且 pow_glue.js 加载后 wasm_bindgen.solve_pow_batched 可用；解题结果经 __owaf_pow_callback 回传。
