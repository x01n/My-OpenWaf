...
HANDLER["站点处理器 handler_site.go"]
REPO["站点仓库 repository/site.go"]
MODELS["站点模型 models.go"]
end
...
- [add-site-dialog.tsx:1-254](file://frontend/components/add-site-dialog.tsx#L1-L254)
- [api.ts:1-115](file://frontend/lib/api.ts#L1-L115)
...
participant Handler as "站点处理器<br/>handler_site.go"
...
**图表来源**
- [router.go:125-130](file://internal/admin/router.go#L125-L130)
- [handler_site.go:51-65](file://internal/admin/handler_site.go#L51-L65)
- [site.go:40-44](file://internal/store/repository/site.go#L40-L44)
...
- [router.go:125-127](file://internal/admin/router.go#L125-L127)
- [server.go:220-242](file://internal/app/server.go#L220-L242)
...
```mermaid
graph LR
Router["路由层<br/>admin/router.go"] --> Handler["站点处理器<br/>admin/handler_site.go"]
Handler --> Repo["仓库层<br/>store/repository/site.go"]
Repo --> Models["模型定义<br/>store/models.go"]
...
- [handler_site.go:51-107](file://internal/admin/handler_site.go#L51-L107)
- [site.go:9-45](file://internal/store/repository/site.go#L9-L45)
- [models.go:94-148](file://internal/store/models.go#L94-L148)
- [server.go:220-260](file://internal/app/server.go#L220-L260)
- [build.go:52-143](file://internal/snapshot/build.go#L52-L143)
