...
B --> K["internal/store/models.go<br/>领域模型定义"]
```
...
- [internal/core/config.go:1-151](file://internal/core/config.go#L1-L151)
- [internal/store/migrate.go:1-52](file://internal/store/migrate.go#L1-L52)
- [internal/store/migrations/v2_single_site.go:1-189](file://internal/store/migrations/v2_single_site.go#L1-L189)
- [internal/store/repository/repository.go:1-33](file://internal/store/repository/repository.go#L1-L33)
- [internal/store/repository/site.go:1-45](file://internal/store/repository/site.go#L1-L45)
- [internal/store/repository/rule.go:1-40](file://internal/store/repository/rule.go#L1-L40)
...
- 仓储层：按实体拆分仓库，统一通过 Repos 聚合注入到业务层
...
- [internal/store/repository/site.go:13-23](file://internal/store/repository/site.go#L13-L23)
- [internal/store/repository/rule.go:13-28](file://internal/store/repository/rule.go#L13-L28)
- [internal/store/models.go:14-147](file://internal/store/models.go#L14-L147)
