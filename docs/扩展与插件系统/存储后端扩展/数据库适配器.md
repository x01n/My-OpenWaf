...
- [docs/扩展与插件/存储后端扩展/存储后端扩展.md](file://docs/扩展与插件/存储后端扩展/存储后端扩展.md)
- [docs/扩展与插件/存储后端扩展/连接池管理.md](file://docs/扩展与插件/存储后端扩展/连接池管理.md)
- [docs/扩展与插件/存储后端扩展/数据库适配器.md](file://docs/扩展与插件/存储后端扩展/数据库适配器.md)
- [docs/数据存储层/多数据库支持.md](file://docs/数据存储层/多数据库支持.md)
- [docs/数据存储层/GORM 配置与使用.md](file://docs/数据存储层/GORM 配置与使用.md)
- [docs/扩展与插件/存储后端扩展/存储迁移机制.md](file://docs/扩展与插件/存储后端扩展/存储迁移机制.md)
...
- [docs/扩展与插件/存储后端扩展/连接池管理.md:144-152](file://docs/扩展与插件/存储后端扩展/连接池管理.md#L144-L152)
...
**章节来源**
- [docs/扩展与插件/存储后端扩展/连接池管理.md:368-383](file://docs/扩展与插件/存储后端扩展/连接池管理.md#L368-L383)
- [docs/数据存储层/GORM 配置与使用.md:115-122](file://docs/数据存储层/GORM 配置与使用.md#L115-L122)
- [docs/扩展与插件/存储后端扩展/数据库适配器.md:332-342](file://docs/扩展与插件/存储后端扩展/数据库适配器.md#L332-L342)
...
**章节来源**
- [docs/扩展与插件/存储后端扩展/存储迁移机制.md:33-421](file://docs/扩展与插件/存储后端扩展/存储迁移机制.md#L33-L421)
- [internal/store/migrate.go:9-37](file://internal/store/migrate.go#L9-L37)
- [internal/store/seed.go:13-61](file://internal/store/seed.go#L13-L61)