...
- [迁移管理机制.md](file://docs/扩展与插件系统/存储后端扩展/存储迁移机制.md)
...
- 文档支撑：docs/扩展与插件系统/存储后端扩展/存储迁移机制.md、docs/数据存储层/数据迁移管理.md、docs/配置管理系统/迁移管理机制.md
...
**章节来源**
- [v2_single_site.go:16-50](file://internal/store/migrations/v2_single_site.go#L16-L50)
- [迁移管理机制.md:444-468](file://docs/扩展与插件系统/存储后端扩展/存储迁移机制.md#L444-L468)
...
**章节来源**
- [迁移管理机制.md:385-394](file://docs/扩展与插件系统/存储后端扩展/存储迁移机制.md#L385-L394)
...
**章节来源**
- [迁移管理机制.md:369-380](file://docs/扩展与插件系统/存储后端扩展/存储迁移机制.md#L369-L380)
