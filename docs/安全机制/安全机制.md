...
### 登录与密码策略
- 登录前端
  - 提供用户名与密码表单，调用登录接口并跳转到仪表板
- 密码策略
  - 系统保护配置包含最小密码长度、最大尝试次数与锁定时长等字段
  - 建议结合强口令与多因子认证，避免弱口令风险

章节来源
- [page.tsx:18-30](file://frontend/app/login/page.tsx#L18-L30)
- [models.go:285-313](file://internal/store/models.go#L285-L313)
