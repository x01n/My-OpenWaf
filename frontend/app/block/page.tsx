export default function BlockPage() {
  return (
    <main className="min-h-svh bg-[radial-gradient(circle_at_top_left,#fff1f2,#f8fafc_36%,#eef2ff)] px-6 py-10 text-slate-950 dark:bg-[radial-gradient(circle_at_top_left,#7f1d1d,#020617_56%,#030712)] dark:text-slate-50">
      <section className="mx-auto flex min-h-[calc(100svh-5rem)] max-w-3xl items-center justify-center">
        <div className="w-full overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 shadow-2xl shadow-slate-900/10 backdrop-blur dark:border-slate-700/70 dark:bg-slate-950/82 dark:shadow-black/40">
          <div className="h-1.5 bg-gradient-to-r from-rose-500 via-orange-500 to-indigo-500" />
          <div className="space-y-8 p-8 sm:p-10">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-rose-50 text-3xl text-rose-700 ring-1 ring-rose-100 dark:bg-rose-950/40 dark:text-rose-200 dark:ring-rose-900/60">
                x
              </div>
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-7 text-slate-600 dark:text-slate-300">
                  请求已被 My-OpenWaf
                  防护策略拦截。为避免暴露内部检测细节，此页面仅展示可用于排查的请求编号。
                </p>
              </div>
            </div>
