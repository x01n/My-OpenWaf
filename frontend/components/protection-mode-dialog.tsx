      ...
      <DialogContent className="max-w-2xl rounded-lg p-0">
        <DialogHeader className="border-b border-slate-200 bg-white px-6 py-5 text-left">
          ...
          <DialogDescription className="mt-1 text-sm leading-6 text-slate-600">
            该设置用于切换站点的即时处理策略，确认后会走真实更新接口并触发运行时生效。
          </DialogDescription>
        </DialogHeader>
              ...
              >
                <div
                  className={cn(
                    ...
                    active ? mode.iconBox : "bg-white text-slate-500"
                  )}
                >
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span
                      className={
                        active
                          ? "console-badge border-slate-200 bg-white text-slate-900"
                          : "console-badge border-slate-200 bg-slate-100 text-slate-500"
                      }
                    >
                      {active ? "当前选择" : "可切换"}
                    </span>
