...
type Config struct {
	...
	// MaxHeaderListSize optionally specifies the maximum header list size
	// the server is willing to accept. If zero, a default value is used.
	MaxHeaderListSize uint32

	// MaxHeaderFields optionally specifies the maximum number of header
	// fields the server is willing to accept. If zero, no explicit limit
	// is enforced on the field count.
	MaxHeaderFields int
...
// WithServerMaxHeaderListSize is used to set the max header list size.
func WithServerMaxHeaderListSize(n uint32) Option {
	return Option{F: func(o *Config) {
		o.MaxHeaderListSize = n
	}}
}

// WithServerMaxHeaderFields is used to set the max header fields count.
func WithServerMaxHeaderFields(n int) Option {
	return Option{F: func(o *Config) {
		o.MaxHeaderFields = n
	}}
}
